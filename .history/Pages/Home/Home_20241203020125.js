        ...
        <View style={styles.forecastContainer}>
          ...
          <View style={styles.OtherStatsContainer}>
            <View style={styles.OtherStats}>
              <FontAwesomeIcon icon={faWind}  size={scaleFontsSize(20)} color="#ffffff"/>
              <Text>22km</Text>
            </View>
            <View style={styles.OtherStats}>
              <FontAwesomeIcon icon={faDroplet}  size={scaleFontsSize(20)} color="#ffffff"/>
              <Text>23%</Text>
            </View>
            <View style={styles.OtherStats}>
              <FontAwesomeIcon icon={faSun}  size={scaleFontsSize(20)} color="#ffffff"/>
              <Text>6:05 AM</Text>
            </View>
          </View>
        </View>
